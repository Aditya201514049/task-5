...
function generateCoverUrl(faker, title, author) {
  ...
  // Using a placeholder service for book covers
  return `https://via.placeholder.com/300x400/${color}?text=${encodeURIComponent(title.substring(0, 20))}`;
}
